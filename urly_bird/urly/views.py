...
def register(request):
    ...
    return render(request, 'urly/register.html', {'form': form}


class ClickCreate(CreateView):
    model = Click
    fields = ['author', 'title', 'timestamp', 'accessed', 'orig', 'short']

class ClickUpdate(UpdateView):
    model = Click
    fields = ['author', 'title', 'timestamp', 'accessed', 'orig', 'short']

class ClickDelete(DeleteView):
    model = Click
